            ...
            <div style={{ height: "400px", width: "100%", marginBottom: "20px" }}>
                <MapContainer center={[centro.lat, centro.lng]} zoom={13} style={{ height: "100%", width: "100%" }}>
                    ...
                    {listaDeMascotas.map((mascota) => (
                        <Marker key={mascota.id}position={[parseFloat(mascota.lat), parseFloat(mascota.lng)]} icon={mascota.tipo === "perdida" ? iconoPerdida : iconoEncontrada}>
                            <Popup>
                ...
                {listaDeMascotas.map((mascota) => (
                    <div key={mascota.id} className="col-md-4 mb-3">
                        <div className={`card border-${mascota.tipo === "perdida" ? "danger" : "primary"}`}>
                            <img src={mascota.foto}alt="Mascota" className="card-img-top img-fluid"style={{ height: "200px", objectFit: "cover" }} />
